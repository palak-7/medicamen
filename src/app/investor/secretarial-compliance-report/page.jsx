          ...
          <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
            ...
            <tbody>
              <tr class="odd:bg-white  even:bg-gray-50  border-b">
                ...
                <td class="px-6 py-4">
                  <Link href="/investors/files/file-43.pdf" target="__blank">
              ...
              <tr class="odd:bg-white even:bg-gray-50 ">
                <td class="px-6 py-4">
                  2021 Annual Secretarial Compliance Report
                </td>
                <td class="px-6 py-4">
                  <Image src="/investors/pdf.png" width={100} height={100} />
                </td>
                <td class="px-6 py-4">
                  <Link href="/investors/files/file-44.pdf" target="__blank">
                    <div className="underline">Click Here</div>
                  </Link>
                </td>
                <td class="px-6 py-4"></td>
              ...
              <tr class="odd:bg-white even:bg-gray-50 ">
                <td class="px-6 py-4">
                  2020 Annual Secretarial Compliance Report
                </td>
                <td class="px-6 py-4">
                  <Image src="/investors/pdf.png" width={100} height={100} />
                </td>
                <td class="px-6 py-4">
                  <Link href="/investors/files/file-45.pdf" target="__blank">
                    <div className="underline">Click Here</div>
                  </Link>
                </td>
                <td class="px-6 py-4"></td>
